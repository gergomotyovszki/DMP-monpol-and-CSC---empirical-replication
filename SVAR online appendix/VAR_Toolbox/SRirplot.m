function SRirplot(IRF,pick,vnames,snames,filename,INF,SUP,PanelTitle,FontSize)
% =======================================================================
% Plot the IRFs computed with SR (sign restriction procedure)
% =======================================================================
% SRirplot(IRF,pick,vnames,snames,filename,INF,SUP,PanelTitle,FontSize)
% -----------------------------------------------------------------------
% INPUT
%   IRF(:,:,:) : matrix with periods, variable, shock
%
% OPTIONAL INPUT
%   pick     : a scalar for the position of chosen shock [default 0 = all]. 
%              The routine will plot responses of all variables to chosen
%              shocks
%   vnames   : name of the variables ordered as in the VAR
%   snames   : name of the shocks
