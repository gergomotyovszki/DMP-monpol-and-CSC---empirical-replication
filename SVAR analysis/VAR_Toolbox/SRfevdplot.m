function SRfevdplot(FEVD,pick,vnames,snames,filename,INF,SUP,PanelTitle,FontSize)
% =======================================================================
...
%
% OPTIONAL INPUT
%   pick     : a scalar for the position of chosen variable [default 0 = all]. 
%              The routine will plot FEVD of chosen variable to all
%              shocks
